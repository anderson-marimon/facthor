...
@Component({
	selector: 'upload-proof-disbursement-reserve-drag-input-files',
	templateUrl: 'reserve-drag-input-files.html',
	animations: [
...
export class UploadProofDisbursementReserveDragInputFiles {
