...
@Component({
	selector: 'view-proof-disbursement-table-filters',
...
export class ViewProofDisbursementTableFilters {
	...
	private _getProofDisbursementsByFilters(args: Partial<Omit<TApiGetActiveOperationsListQueryParams, 'Size'>>): void {
