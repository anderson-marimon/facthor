...
import { ActiveOperationsOrderOperationsTable } from '@dashboard/modules/operations-management/view-operations-details/components/order-operations-table/order-operations-table';
...
export default class OperationsManagementViewOperationsDetails {
	...
	private _getAccessInformation(): void {
		this._activateRoute.data.pipe(takeUntilDestroyed(this._destroyRef)).subscribe((data) => {
			...
			this._sessionKey = data[EAccessInformation.SESSION_KEY];
		});
