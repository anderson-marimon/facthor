...
const variants = cva(
	...
	focus-visible:outline-none focus-visible:ring-[0.1vh] lg:focus-visible:ring-[0.1vh] focus-visible:ring-ring
	focus-visible:ring-offset-[0.2vh] ring-offset-background disabled:opacity-50 disabled:pointer-events-none
	[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 select-none`,
	{
		variants: {
			...
			size: {
				default: 'h-[4vh] px-[2vh] text-[1.5vh] py-[0.5vh]',
				sm: 'h-[3.5vh] rounded px-[0.75vh]',
				lg: 'h-[4.5vh] rounded px-[4vh]',
