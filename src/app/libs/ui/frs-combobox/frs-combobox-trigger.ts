...
const variants = cva(
    `block flex items-center gap-2.5 py-2 border rounded-md focus-visible:outline-none focus-visible:ring-1
	focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background [&>div]:flex-1 [&>div]:max-w-full
	[&>div]:overflow-hidden [&>div]:text-ellipsis [&>div]:whitespace-nowrap [&>div]:white-space-no
